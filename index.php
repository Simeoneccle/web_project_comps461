    ...
    while ($rows = mysqli_fetch_array($result)) {
        echo '
                      <tr>
                        ...
                        <td><a class="btn btn-info col-12" href="edit_drug.php?id=' . $rows['ID'] . '">EDIT</a></td>
                        <td><a class="btn btn-danger col-12" href="index.php?delete=true&medicine_id=' . $rows['ID'] . '">DELETE</a></td>
                    </tr>
                ';
        $count += 1;
    }
